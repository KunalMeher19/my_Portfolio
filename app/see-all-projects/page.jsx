...
const Page = () => {
  ...
  const textOnlyProjects = [
    ...
    // },
    {
      ...
      description: "A website for a freelance client with a visually appealing interface, featuring responsive design and modern UI components.",
      tech: ["Vite", "Tailwind", "React", "Vercel"],
      github: "https://getkinetia.com",
    },
    {
      title: "Nostrum - freelance",
      description: "Nostrum - a freelancing project which is visually appealing landing page for olivve oil and showcasing modern web design principles and interactive elements.",
      tech: ["Vite", "Tailwind", "Framer", "TypeScript"],
      github: "https://demo-live-store.netlify.app/",
    },
    // {
