...
const Terminal = () => {
  ...
  const executeCommand = (cmd) => {
    ...
    switch (command) {
      ...
      case 'about':
        output.push({ text: '╔════════════════════════════════════╗', type: 'system-border' })
        output.push({ text: '║           ABOUT ARDHENDU           ║', type: 'system-header' })
        output.push({ text: '╚════════════════════════════════════╝', type: 'system-border' })
      ...
      case 'neofetch':
        output.push({ text: '          ardhendu@portfolio', type: 'system' })
        output.push({ text: '          -----------------', type: 'system' })
        output.push({ text: '          OS: Vite/React', type: 'system' })
        output.push({ text: '          Host: Portfolio v3.0.0', type: 'system' })
        output.push({ text: '          Uptime: 6+ months', type: 'system' })
        output.push({ text: '          Skills: Javascript, Tailwind, React', type: 'system' })
        output.push({ text: '          Projects: 15+', type: 'system' })
        output.push({ text: '          GitHub: github.com/KunalMeher19', type: 'system' })
      ...
      case 'cowsay':
        const message = params.length > 0 ? params.join(' ') : 'Hire Ardhendu, he\'s awesome!'
