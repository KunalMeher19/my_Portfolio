...
const testimonials = [
  {
    ...
    content: "Ardhendu exceeded all our expectations. His ability to translate our vision into a stunning website was impressive. He was responsive, creative, and delivered on time.",
    color: "#00eeff"
  },
  {
    id: 3,
  ...
  },
  {
    ...
    content: "As a developer, I had all the code ready, but my website looked terrible. I was feeling stuck until Ardhendu helped me explore new ideas and craft a stunning website!",
    color: "#00eeff"
  },
  {
    id: 2,
    ...
    image: "/mohd.webp",
    content: "Ardhendu built us a clean, professional, and user-friendly website while ensuring a smooth process. He was responsive, made changes as needed, and offered great suggestions. Highly recommended!",
    color: "#ee00ff"
  }
];
