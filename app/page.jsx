    ...
    <>
      ...
      <div className="w-full dark min-h-screen pb-10 bg-[#0c0c0c] relative overflow-hidden">
        ...
        <div className="px-6 unselectable py-7 md:px-12 md:py-8 lg:px-24 lg:py-8 max-w-[100rem] mx-auto flex flex-col relative z-10">
          ...
          <div className="flex flex-col gap-3 md:flex-row flex-1 max-h-[100rem] md:pt-0">
            <div className="md:w-2/4 flex flex-col justify-between md:justify-end pb-10 md:pb-10 mt-10 md:mt-0 relative order-last md:order-first">
              ...
              <div className="hidden md:block">
                <div className="relative">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 mb-5 max-w-[530px] w-full">
            ...
            <div className="md:w-2/4 flex items-start mt-20 md:mt-36 justify-center md:justify-end relative">
              ...
              <div className="text-left md:text-right md:text-[3.35rem] sm:text-[2.8rem] text-[2.5rem] text-[#f4f4f4]">
                ...
                <h1 className="mb-7 leading-[1.4] font-thin">
                  Crafting Digital Experiences
                  With <br />Code and Design
                </h1>
                ...
                <button
                  ...
                  className="mt-10 sm:px-6 sm:py-3 px-4 py-2 border-2 border-[#bcbcbc] text-white bg-[#06449114] font-medium rounded-xl hover:bg-[#8306912e] hover:scale-[1.03] transition-all ease-in-out duration-300 text-sm tracking-wider"
                >
                  CONTACT ME
                </button>
              </div>
            ...
            <div
              className="absolute bottom-0 left-6 md:left-auto md:right-10 flex items-center space-x-2 group"
            ...
            <div className="p-6 sm:p-8 md:p-10">
              <div className="flex flex-col">
                ...
                <h3 className="text-white text-xl sm:text-2xl md:text-3xl mb-2">
                  Velo.new - No code Full stack website builder
                </h3>

                <p className="text-white/70 text-xs sm:text-sm max-w-2xl mb-4">
                  An AI-powered full-stack website generator — no coding needed.
                  Just provide a detailed prompt, and Velo.new will generate your website code in under 5 minutes. You can further refine the output by submitting additional prompts.
                  Preview the result instantly, then download the code or upload it directly to GitHub.
                </p>

                <div className="flex flex-wrap gap-3 sm:gap-4">
                  <div className="relative group inline-block">
                    <button
                      className="px-3 sm:px-4 py-1.5 sm:py-2 border-2 border-[#00eeff]/30 text-[#00eeff]/80 bg-[#00eeff]/5 rounded-xl transition-all ease-out duration-300 text-xs sm:text-sm tracking-wider hover:scale-[1.01] hover:cursor-not-allowed hover:opacity-50 hover:text-[#00eeff]/50 hover:border-[#00eeff]/20 hover:bg-[#00eeff]/10"
                    >
                      <span className="block group-hover:hidden">View Website</span>
                      <span className="hidden group-hover:block">On Process...</span>
                    </button>
                  </div>

                  <button
                    onClick={() => window.open("https://github.com/KunalMeher19/Velo.new", "_blank")}
            ...
            {[
              ...
              >
                <div className="aspect-[16/9] w-full overflow-hidden">
                  <img
                    src={project.image}
                    className={`w-full h-full object-cover transition-transform duration-500 ${project.white ? "opacity-[0.93]" : ""
                      }`}
                  />
                </div>
            ...
            >
              ...
              <div className="space-y-4 sm:space-y-5 flex-grow relative z-10">
                <p className="text-white/80 text-xs sm:text-sm leading-relaxed border-l-2 border-[#ee00ff]/30 pl-3 py-1">
                  ...
                  spent countless nights teaching myself Java before gradually
                ...
                <p className="text-white/80 text-xs sm:text-sm leading-relaxed border-l-2 border-[#00eeff]/30 pl-3 py-1">
                  Doing freelancing has let me work with incredible
                  ...
                  beginning I'm now diving into Rust, Flutter, and Java to take
                ...
                <div className="flex flex-col justify-between h-full">
                  {[
                    ...
                    },
                    {
                      ...
                      company: "Sheriyans",
                      description:
                        "I am a part of hackathon Core Team, where I've contributed to various 3D projects and events in that hackathon",
